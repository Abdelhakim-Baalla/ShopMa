        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">{{ $products_details[0]->titre }}</span>
                </div>
            </li>
        </ol>
    </nav>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="bg-gray-50 p-6 flex items-center justify-center">
                <div class="relative group w-full h-full flex items-center justify-center">
                    <img src="{{ $products_details[0]->image }}" 
                         class="max-h-96 object-contain rounded-lg transition-all duration-300 group-hover:scale-105" 
                         alt="{{ $products_details[0]->titre }}">
                </div>
            </div>
            
            <div class="p-8 flex flex-col">
                <div class="mb-auto">
                    <h1 class="text-3xl font-bold text-gray-900 tracking-tight">{{ $products_details[0]->titre }}</h1>
                ...
                <div class="border-t border-gray-200 pt-6">
                    <div class="flex items-end justify-between mb-6">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900">{{ $products_details[0]->prix }} <span class="text-sm font-medium">MAD</span></p>
                        </div>
                    </div>

                    <form action="/ajouter/panier" method="POST">
                        @csrf
                        <input type="hidden" name="product_id" value="{{ $products_details[0]->id }}">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <div class="w-full sm:w-1/4">
                                ...
                                <div class="relative flex items-center">
                                    ...
                                    <input type="number" id="quantite" name="quantite" value="1" min="1" max="99" 
                            ...
                            <div class="w-full sm:w-3/4 flex space-x-4">
                                <button type="submit" class="flex-1 bg-red-600 hover:bg-red-700 text-white py-3 px-6 rounded-md font-medium transition duration-200 ease-in-out flex items-center justify-center">
    ...
    <div class="mt-12">
        ...
        <div class="py-6">
            ...
            <div class="prose prose-sm max-w-none text-gray-500">
                <p>{{ $products_details[0]->description }}</p>
            </div>
        </div>
    </div>
</div>
